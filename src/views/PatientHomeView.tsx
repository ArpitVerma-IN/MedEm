            ...
            <div className="flex-1 bg-gray-50 dark:bg-gray-900 rounded-t-[2.5rem] shadow-[0_-12px_30px_rgb(0,0,0,0.15)] relative z-10 -mt-6 p-6 flex flex-col items-center gap-6 min-h-[500px] w-full">
                ...
                <button
                    ...
                    className={clsx(
                        ...
                        needsCare
                            ? "bg-success-DEFAULT text-white hover:bg-success-dark shadow-success-DEFAULT/30"
                            : "bg-danger-DEFAULT text-white hover:bg-danger-dark shadow-danger-DEFAULT/30"
                    )}
                >
                    {needsCare ? (
                        <>
                ...
                <AnimatePresence mode="wait">
                    ...
                    {isConnecting && (
                        ...
                        >
                            <Loader2 className="animate-spin text-med-DEFAULT mb-4" size={48} />
                    ...
                    {isTimeoutReached && (
                        ...
                        >
                            <div className="w-16 h-16 bg-danger-50 dark:bg-danger-900/20 text-danger-DEFAULT rounded-full flex items-center justify-center mb-4">
                                <AlertCircle size={32} />
                            </div>
                ...
                {incomingDoctors.length > 0 && (
                    <motion.div
                        ...
                        className="mt-2 w-full max-w-md bg-success-DEFAULT dark:bg-success-dark text-white p-5 rounded-[1.5rem] shadow-xl border border-success-light/30 flex flex-col gap-3 relative overflow-hidden shrink-0"
                    >
