                            ...
                            >
                                ...
                                <div className="flex flex-col gap-2">
                                    <div className="relative">
                                        <select
                                            className="w-full appearance-none bg-slate-100 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-slate-100 text-sm font-semibold rounded-xl px-4 py-3.5 pr-10 focus:outline-none focus:ring-2 focus:ring-danger/50 transition-shadow drop-shadow-sm cursor-pointer"
                                    ...
                                    {acceptingPatientId && nearbyPatients.find(p => p.user.id === acceptingPatientId) && (
                                        <motion.div
                                            ...
                                            className="mt-1 flex items-center justify-center gap-2 bg-success/10 dark:bg-success-dark/20 text-success dark:text-success-light py-2 rounded-xl border border-success/20"
                                        >
