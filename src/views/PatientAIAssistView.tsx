    ...
    return (
        ...
        >
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-800 mb-4">
                <h3 className="font-semibold text-lg text-med mb-2">Generate Reports Summary</h3>
                ...
                <button className="w-full bg-med text-white font-medium py-3 rounded-xl shadow-md hover:bg-med-dark transition-colors">
                    Upload New Record
                </button>
            </div>
            ...
            <div className="bg-med-light/20 dark:bg-med-dark/30 rounded-2xl p-5 border border-med-light/30 dark:border-med-dark mb-4">
                <div className="flex items-center space-x-3 mb-3">
                    <div className="w-2 h-2 rounded-full bg-med animate-pulse" />
                    <h4 className="font-semibold text-med-dark dark:text-med-light">Pending Report Analysis</h4>
                </div>
                <p className="text-xs text-med dark:text-med-light font-medium tracking-wide">
